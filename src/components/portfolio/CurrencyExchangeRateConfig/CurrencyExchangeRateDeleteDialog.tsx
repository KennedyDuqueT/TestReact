...
export const CurrencyExchangeRateDeleteDialog: FC<Props> = ({ entityName, fullEntityName }) => {
  const { t } = useTranslation();
  const { selectedItem, openDeleteDialog, actions } = useCurrencyExchangeRateConfig();
