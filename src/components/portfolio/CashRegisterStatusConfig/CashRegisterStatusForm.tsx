...
interface FormValues extends CashRegisterStatus {}

interface Props {
  initialValues?: CashRegisterStatus;
}

export const CashRegisterStatusForm: FC<Props> = ({ initialValues }) => {
  const { t } = useTranslation();
  const { selectedItem, actions } = useCashRegisterStatusConfig();
