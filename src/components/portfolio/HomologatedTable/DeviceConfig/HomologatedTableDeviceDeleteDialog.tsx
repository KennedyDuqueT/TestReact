...
export const HomologatedTableDeviceDeleteDialog: FC<Props> = ({ entityName, fullEntityName }) => {
  const { t } = useTranslation();
  const { selectedItem, openDeleteDialog, actions } = useHomologatedTableConfig();
