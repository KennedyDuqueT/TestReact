...
interface FormValues extends LotStatus {}

interface Props {
  initialValues?: LotStatus;
}

export const LotStatusForm: FC<Props> = ({ initialValues }) => {
  const { t } = useTranslation();
  const { selectedItem, actions } = useLotStatusConfig();
